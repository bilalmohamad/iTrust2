...
public class HCPController {
    ...
    /**
     * Retrieves the page for the HCP to upload Passenger data
     *
     * @return The page to display to the HCP.
     */
    @GetMapping ( "/aquatranquilica/uploadPassengerList" )
    @PreAuthorize ( "hasAnyRole('ROLE_HCP')" )
    public String uploadPassengerList () {
        return "/aquatranquilica/uploadPassengerList";
    }

    /**
     * Retrieves the page for the HCP to calculate r0
     *
     * @return The page to display to the HCP.
     */
    @GetMapping ( "/aquatranquilica/calculateR0" )
    @PreAuthorize ( "hasAnyRole('ROLE_HCP')" )
    public String calculateR0 () {
        return "/aquatranquilica/calculateR0";
    }

    /**
     * Retrieves the page for the HCP to plot relevant passenger statistics
     *
     * @return The page to display to the HCP.
     */
    @GetMapping ( "/aquatranquilica/plotStatistics" )
    @PreAuthorize ( "hasAnyRole('ROLE_HCP')" )
    public String plotStatistics () {
        return "/aquatranquilica/plotStatistics";
    }
}
