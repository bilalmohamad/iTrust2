...
public enum TransactionType {
     ...
     * HCP adds blood sugar limits for a patient
     */
    UPLOAD_PASSENGER_DATA ( 2701, "HCP uploads a list of passengers.", false ),
    /**
     * HCP adds blood sugar limits for a patient
     */
    PLOT_PATIENT_STATISTICS ( 2702, "HCP plots the statistics of the passengers.", false ),
    /**
     * HCP adds blood sugar limits for a patient
     */
    CALCULATE_R_NAUGHT ( 2704, "HCP calculates the value of R_Naught.", false );
