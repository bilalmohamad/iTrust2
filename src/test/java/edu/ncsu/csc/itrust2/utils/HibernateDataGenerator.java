...
public class HibernateDataGenerator {
    ...
    /**
     * Generates the passengers needed for testing.
     *
     * @throws ParseException
     * @throws NumberFormatException
     */
    public static void generatePassengers () throws NumberFormatException, ParseException {
        ...
        final Passenger marwah = new Passenger();
        // marwah.setSelf(user1);
        marwah.setPassengerId( "1234abcd" );
        // marwah.setFirstName( "Marwah" );
        // marwah.setLastName("Mahate");
        marwah.setName( "Marwah Mahate" );
        marwah.setSeverityCode( SeverityCode.M );
        marwah.setStartDateOfSymptoms( LocalDate.now() );
        marwah.save();
        ...
        final Passenger bilal = new Passenger();
        // bilal.setSelf(user2);
        bilal.setPassengerId( "12345678" );
        // bilal.setFirstName( "Bilal" );
        // bilal.setLastName( "Mohamad" );
        bilal.setName( "Bilal Mohamad" );
        bilal.setSeverityCode( SeverityCode.C );
        bilal.setStartDateOfSymptoms( LocalDate.parse( "2020-04-01" ) );
        bilal.save();
        ...
        final Passenger inayya = new Passenger();
        // inayya.setSelf(user3);
        inayya.setPassengerId( "12345677" );
        // inayya.setFirstName( "Inayya" );
        // inayya.setLastName( "Mohamad" );
        inayya.setName( "Inayya Mohamad" );
        inayya.setSeverityCode( SeverityCode.C );
        inayya.setStartDateOfSymptoms( LocalDate.parse( "2020-04-01" ) );
        inayya.save();
        ...
        final Passenger iman = new Passenger();
        // iman.setSelf(user4);
        iman.setPassengerId( "12345679" );
        // iman.setFirstName( "Iman" );
        // iman.setLastName( "Mohamad" );
        iman.setName( "Iman Mohamad" );
        iman.setSeverityCode( SeverityCode.C );
        iman.setStartDateOfSymptoms( LocalDate.parse( "2020-04-01" ) );
        iman.save();

        // SortedMap<LocalDate, Integer> t = Passenger.countByDate();

        // for (Map.Entry<LocalDate, Integer> entry : t.entrySet()) {
